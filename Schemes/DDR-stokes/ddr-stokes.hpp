...
/*
 * This implementation is based on the principles described in
 *
 *   An arbitrary-order discrete de Rham complex on polyhedral meshes. Part I: Exactness and Poincaré inequalities. 
 *   D. A. Di Pietro and J. Droniou, 31p, 2021. url: https://arxiv.org/abs/2101.04940.
 *
 *   An arbitrary-order discrete de Rham complex on polyhedral meshes. Part II: Consistency.
 *   D. A. Di Pietro and J. Droniou, 33p, 2021. url: https://arxiv.org/abs/2101.04946.
 * 
 *
...
namespace HArDCore3D
{
  ...
  struct Stokes
  {
    ...
    /// Compute the L2 norms of u, curl u, p and grad p
    StokesNorms computeStokesNorms(
