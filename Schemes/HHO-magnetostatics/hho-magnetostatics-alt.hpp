#ifndef HHO_MAGNETOSTATICS_ALT_HPP
#define HHO_MAGNETOSTATICS_ALT_HPP
...
namespace HArDCore3D
{
  ...
  struct HHOMagnetostatics
  {
    ...
    inline const XSpace_alternative_faceBasis & xSpace() const
    {
      return m_xspace;
    }
    ...
    /// Returns the dimension of the linear system system
  ...
  private:
    ...
    XSpace_alternative_faceBasis m_xspace;
    YSpace m_yspace;
    ZSpace m_zspace;
                                       ...
                                       )->void
                       {
                         for (size_t iT = start; iT < end; iT++) {
                           this->_assemble_statically_condensed(
                                                                iT,
                                                                this->_compute_local_contribution(iT, f, u, p),
                                                                *my_triplets,
                                                                *my_rhs
                                                                );
                         } // for iT
